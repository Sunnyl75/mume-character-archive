...
def main():
    ...
    for row in classification_rows:
        ...
        manifest_rows.append({
            ...
            "derived_who_class_group": clean(row.get("derived_who_class_group")),
            "derived_class_title": clean(row.get("derived_class_title")),
            "derived_class_confidence": clean(row.get("derived_class_confidence")),
            "derived_class_skill_notes": clean(row.get("derived_class_skill_notes")),
            "derived_class_level_restriction_notes": clean(row.get("derived_class_level_restriction_notes")),
            "derived_class_race_restriction_notes": clean(row.get("derived_class_race_restriction_notes")),
            "derived_class_alignment_restriction_notes": clean(row.get("derived_class_alignment_restriction_notes")),
